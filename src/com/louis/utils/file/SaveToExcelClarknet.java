 ...
 * 将提取的特征保存到excel中
 * */
public class SaveToExcelClarknet {
...
//		name.add("second");
        ...
        //秒
      	...
      	String monthFile = "F:\\autoScaling\\request\\ClarkNet\\month.xls";
    	String dayFile = "F:\\autoScaling\\request\\ClarkNet\\day.xls";
    	String weekFile = "F:\\autoScaling\\request\\ClarkNet\\week.xls";
    	String hourFile = "F:\\autoScaling\\request\\ClarkNet\\hour.xls";
    	String minuteFile = "F:\\autoScaling\\request\\ClarkNet\\minute.xls";
    	String requestFile = "F:\\autoScaling\\request\\ClarkNet\\request.xls";
    	String maxReq20minutesFile = "F:\\autoScaling\\request\\ClarkNet\\maxReq20minutes.xls";
    	String minReq20minutesFile = "F:\\autoScaling\\request\\ClarkNet\\minReq20minutes.xls";
    	String meanReq20minutesFile = "F:\\autoScaling\\request\\ClarkNet\\meanReq20minutes.xls";
//      	SaveAsExcel.save4(fileName, name, list);
      	SaveAsExcel.save3(monthFile, "month", month);
      	SaveAsExcel.save3(dayFile, "day", day);
      	SaveAsExcel.save3(weekFile, "week", weekTemp);
      	SaveAsExcel.save3(hourFile, "hour", hour);
      	SaveAsExcel.save3(minuteFile, "minute", minute);
    	SaveAsExcel.save3(requestFile, "request", request);
    	SaveAsExcel.save3(maxReq20minutesFile, "maxReq20minutes", maxReq20minutes);
     	SaveAsExcel.save3(minReq20minutesFile, "minReq20minutes", minReq20minutes);
      	SaveAsExcel.save3(meanReq20minutesFile, "meanReq20minutes", meanReq20minutes);
